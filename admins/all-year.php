...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="m-auto h3 mb-0 text-gray-800 text-uppercase">list of years</h1>
    </div>
            ...
            <table class="table table-bordered years_table">
                ...
                foreach ($years as $section) { ?>
                    <tr class="text-center">
                        ...
                        <td><?= $section['name']?></td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#delete_modal" data-href="<?=APP?>/controllers/years/delete.php?id=<?=$section['id']?>" class="btn btn-danger btn-sm delete_link"><i class="fa fa-trash-alt"></i></a>
                            <a data-toggle="modal" data-target="#edit_modal" href="#" data-href="<?=APP?>/controllers/years/get_info.php?id=<?=$section['id']?>" class="btn btn-info btn-sm edit_link"><i class="fa fa-pen-alt"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger d-none error_message text-center"></div>
                <div class="alert alert-success d-none success_message text-center"></div>
                <form class="edit_section_form" action="<?=APP?>/controllers/years/edit.php" method="post"></form>
            </div>
            <div class="modal-footer">
