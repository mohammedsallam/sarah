...
$sql = "SELECT exams.*, years.name AS YNAME, sections.name AS SECNAME
        ...
        WHERE exams.year_id = '$year_id' AND exams.section_id = '$section_id'";
            ...
            <table class="table table-bordered students_table">
                ...
                foreach ($files as $file) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="#" data-toggle="modal" data-target="#delete_modal" data-href="<?=APP?>/controllers/exams/delete.php?id=<?=$file['id']?>&file=<?=$file['file']?>" class="btn btn-danger btn-sm delete_link"><i class="fa fa-trash-alt"></i></a>
                            <a data-toggle="modal" data-target="#edit_modal" href="#" data-href="<?=APP?>/controllers/exams/get_info.php?id=<?=$file['id']?>&file=<?=$file['file']?>&year_id=<?=$_GET['year_id']?>&section_id=<?=$_GET['section_id']?>" class="btn btn-info btn-sm edit_link"><i class="fa fa-pen-alt"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
