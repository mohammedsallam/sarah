...
//            $allow_ext  = array('jpg','jpeg','png','gif', 'pdf', 'doc', 'docx', 'ppt','pptx', 'accdb', 'xlsx');
        ...
        $sql = "INSERT INTO courses SET name='$name', semester='$semester', year_id = '$year_id', section_id = '$section_id', file='$path'";
        $result = mysqli_query($conn, $sql);
        echo json_encode(['status' => 1, 'message' => 'Course added successfully']);
    }
